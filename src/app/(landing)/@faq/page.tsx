    ...
    <div className={styles.faq}>
      ...
      >
        <div className={styles.buttons}>
          <Button
            onClick={() => setActive(0)}
            buttonColor={active === 0 ? 'active' : 'primary'}
          >
            General
          </Button>
          <Button
            onClick={() => setActive(1)}
            buttonColor={active === 1 ? 'active' : 'primary'}
          >
            Application
          </Button>
          <Button
            onClick={() => setActive(2)}
            buttonColor={active === 2 ? 'active' : 'primary'}
          >
            Preparation
          </Button>
          <Button
            onClick={() => setActive(3)}
            buttonColor={active === 3 ? 'active' : 'primary'}
          >
            Health and Safety
          </Button>
        </div>
      ...
      <Flex direction="column" gap="big" className={styles.questions}>
        {faqQuestions[active].map((faq, index) => (
          <Flex direction="column" gap="sm" key={index}>
            <Text
